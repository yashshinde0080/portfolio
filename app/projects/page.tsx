...
const projects = [
  ...
  {
    title: "Multiagent Corp – Multi-Agent Corporate System",
    category: "Agent-Based Orchestration",
    year: "2025",
    context: "Modern software development is fragmented across planning, coding, testing, and documentation. This project models a virtual corporate organization of AI agents to automate end-to-end software development workflows with clear role separation and accountability.",
    constraints: "High coordination overhead between agents, dependency on external APIs (LLMs, Supabase), latency from multi-step orchestration, and limited real-world guarantees without human-in-the-loop validation.",
    decisions: "Designed role-specialized agents (CEO, PM, Research, Coder, QA, Docs) to mirror real corporate workflows. Used centralized orchestration, shared context storage (Supabase), and strict role boundaries to reduce hallucination and task overlap.",
    outcome: "Free to use and alter it its Open socurce",
    reflection: "The system demonstrates strong workflow automation and clarity of responsibility but is only as good as its orchestration logic. Without governance rules and failure handling, multi-agent setups risk becoming slow, noisy, or redundant rather than efficient.",
    image: "/terminal-command-line-interface.jpg",
    tech: ["Python", "Openrouter", "Flask", "Supabase"],
    links: {
      live: null,
      github: "https://github.com/yashshinde0080/fun_model",
    },
  },
]
